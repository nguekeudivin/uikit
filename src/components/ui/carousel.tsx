...
// const CarouselDots = React.forwardRef<HTMLButtonElement, any>(
//   ({ className, current, index }, ref) => {
//     const { orientation, scrollNext, scrollPrev, canScrollNext } =
//       useCarousel();
